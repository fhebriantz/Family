        ...
        <section class="butonproduct mobileshow">
            <div class="container">
                <div class="buttondrop">
                  <a name="allproduct" href="#allproduct" style="color: white"><button type="button" class="btn" style="width: 100%; background: #1e846e;">Gulir ke Bawah</button></a>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <a class="" data-fancybox data-src="#popup-product" href="javascript:;" style="color: #000">
                            <button class="btn btn-product" style="">Product</button>
                        </a>
                    </div>
                    <div class="col-xs-6">
                         <a class="" data-fancybox data-src="#popup-filter" href="javascript:;" style="color: #000">
                            <button class="btn btn-product" style="">Filter</button>
                        </a>
                    </div>
                </div>
            </div>
