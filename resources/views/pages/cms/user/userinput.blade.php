            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="responsive-table">
                        ...
                        @endif
                    	<form method="POST" action="{{url('/cms/forgotpass/input')}}">
						{{ csrf_field() }}
	                        <table class="table">
							<tr>
								<td>Nama</td>
								<td> <input type="text" class="form-control" name="name" placeholder="Nama" value="{{ old('name') }}" style="width: 100%"></td>
							</tr>
                            <tr>
                                <td>Username</td>
                                <td> <input type="text" class="form-control" name="username" placeholder="Nama" value="{{ old('username') }}" style="width: 100%"></td>
                            </tr>
                            <tr>
                                <td>Password</td>
                            ...
                            <tr>
                                  ...
                                  <td><select name="id_usergroup" style="width: 100%">
                                      ...
                                      <option value="2">Admin-Global</option>
                                      <option value="3">Admin-Local</option>
                                  </select></td>
                            </tr>
							<tr>
								<td></td>
