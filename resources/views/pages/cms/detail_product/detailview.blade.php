                ...
                <div class="panel-body">
                    <div class="responsive-table">                    	
	                        <table class="table">
								...
								<tr>
									<td>Frame</td>
									<td><input  class="form-control" type="text" name="frame" placeholder="Frame" value="{{ $product_detail->frame }}" style="width: 100%" readonly></td>
								</tr>

								<tr>
									<td>Fork</td>
									<td><input  class="form-control" type="text" name="fork" placeholder="Fork" value="{{ $product_detail->fork }}" style="width: 100%" readonly></td>
								</tr>

								<tr>
									<td>Brakes Rear</td>
									<td><input  class="form-control" type="text" name="brakes_rear" placeholder="Brakes Rear" value="{{ $product_detail->brakes_rear }}" style="width: 100%" readonly></td>
								</tr>

								<tr>
									<td>Brakes Levers</td>
									<td><input  class="form-control" type="text" name="brakes_levers" placeholder="Brakes Levers" value="{{ $product_detail->brakes_levers }}" style="width: 100%" readonly></td>
								</tr>

								<tr>
									<td>Pedals</td>
									<td><input  class="form-control" type="text" name="pedals" placeholder="Pedals" value="{{ $product_detail->pedals }}" style="width: 100%" readonly></td>
								</tr>

								<tr>
									<td>Crankset</td>
									<td><input  class="form-control" type="text" name="crankset" placeholder="Crankset" value="{{ $product_detail->crankset }}" style="width: 100%" readonly></td>
								</tr>

								<tr>
									<td>Bottom Bracket</td>
									<td><input  class="form-control" type="text" name="bottom_bracket" placeholder="Bottom Bracket" value="{{ $product_detail->bottom_bracket }}" style="width: 100%" readonly></td>
								</tr>

								<tr>
									<td>Chain</td>
									<td><input class="form-control"  type="text" name="chain" placeholder="Chain" value="{{ $product_detail->chain }}" style="width: 100%" readonly></td>
								</tr>

								<tr>
									<td>Cassete</td>
									<td><input class="form-control"  type="text" name="cassete" placeholder="Cassete" value="{{ $product_detail->cassete }}" style="width: 100%" readonly></td>
								</tr>

								<tr>
									<td>Rim</td>
									<td><input class="form-control"  type="text" name="rim" placeholder="Rim" value="{{ $product_detail->rim }}" style="width: 100%" readonly></td>
								</tr>

								<tr>
									<td>Saddle</td>
									<td><input  class="form-control" type="text" name="saddle" placeholder="Saddle" value="{{ $product_detail->saddle }}" style="width: 100%" readonly></td>
								</tr>

								<tr>
									<td>Seatpot</td>
									<td><input  class="form-control" type="text" name="seatpot" placeholder="Seatpot" value="{{ $product_detail->seatpot }}" style="width: 100%" readonly></td>
								</tr>

								<tr>
									<td>Stem</td>
									<td><input class="form-control"  type="text" name="stem" placeholder="Stem" value="{{ $product_detail->stem }}" style="width: 100%" readonly></td>
								</tr>

								<tr>
									<td>Handlebar</td>
									<td><input class="form-control"  type="text" name="handlebar" placeholder="Handlebar" value="{{ $product_detail->handlebar }}" style="width: 100%" readonly></td>
								</tr>
