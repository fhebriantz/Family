...
<div id="content">
    ...
    <div class="col-md-12 top-20 padding-0">
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-heading"><h3>Data Product Detail</h3>  <a href="/family/public/cms/product/subproduct/detail/input"><button type="button" class="btn btn-success" style="margin-bottom: 10px;">Tambah Data</button></a></div>
                <div class="panel-body">
